...
const strings = {
  ...
  "nav.agentConfig": { zh: "Agent 配置", en: "Agent Config" },
  ...
  "agentConfig.title": { zh: "Agent 模型配置", en: "Agent Model Config" },
  "agentConfig.subtitle": { zh: "为每个写作 Agent 分配专用模型，覆盖项目默认设置。", en: "Assign dedicated models to each Agent, overriding project defaults." },
  "agentConfig.useDefault": { zh: "使用默认", en: "Use Default" },
  "agentConfig.selectModel": { zh: "选择或输入模型名", en: "Select or type model name" },
  "agentConfig.noModels": { zh: "未检测到可用模型，请先在「模型配置」中连接服务商", en: "No models detected. Connect a provider in Model Config first." },
  "agentConfig.saveSuccess": { zh: "保存成功", en: "Saved successfully" },
  "agentConfig.saveError": { zh: "保存失败", en: "Save failed" },
  "agentConfig.saving": { zh: "保存中…", en: "Saving…" },
  "agentConfig.editPrompt": { zh: "编辑提示词", en: "Edit Prompt" },
  "agentConfig.backToList": { zh: "返回列表", en: "Back to List" },
  "agentConfig.fullOverride": { zh: "完全覆盖", en: "Full Override" },
  "agentConfig.appendMode": { zh: "追加模式", en: "Append Mode" },
  "agentConfig.fullOverrideDesc": { zh: "完全替换默认系统提示词", en: "Completely replace the default system prompt" },
  "agentConfig.appendModeDesc": { zh: "在默认系统提示词后追加自定义内容", en: "Append custom content after the default system prompt" },
  "agentConfig.promptContent": { zh: "自定义提示词内容", en: "Custom Prompt Content" },
  "agentConfig.promptPlaceholder": { zh: "输入自定义提示词…", en: "Enter custom prompt…" },
  "agentConfig.promptContentPlaceholder": { zh: "当前使用默认提示词", en: "Currently using default prompt" },
  "agentConfig.hasOverride": { zh: "已覆盖", en: "Override Active" },
  "agentConfig.currentMode": { zh: "当前模式", en: "Current mode" },
  "agentConfig.resetOverride": { zh: "重置", en: "Reset" },
  "agentConfig.restoreDefault": { zh: "恢复默认", en: "Restore Default" },
  "agentConfig.noDefaultPrompt": { zh: "该 Agent 暂无默认提示词预览", en: "No default prompt preview available for this agent" },
} as const;
