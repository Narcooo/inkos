...
function parseHash(hash: string): HashRoute {
  ...
  if (path === "agent-prompts") return { page: "agent-prompts" };
...
const HASH_PAGES = new Set(["dashboard", "chat", "book", "book-settings", "book-create", "services", "service-detail", "agent-prompts"]);
